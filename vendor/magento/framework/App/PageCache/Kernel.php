...
class Kernel
{
    ...
    public function process(\Magento\Framework\App\Response\Http $response)
    {
		...
		// «Call to a member function getFieldValue() on boolean
		// in vendor/magento/framework/App/PageCache/Kernel.php:137»:
		// https://github.com/inkifi/site/issues/10
    	if (!$response->getHeader('Cache-Control')) {
    		df_log_l($this, [
    			'response headers' => $response->getHeaders()->toArray(), 'request URL' => df_current_url()
			], 'headers');
		}
