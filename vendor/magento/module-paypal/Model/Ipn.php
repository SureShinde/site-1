...
class Ipn extends \Magento\Paypal\Model\AbstractIpn implements IpnInterface
{
    ...
    protected function _getOrder()
    {
        ...
        if (!$this->_order->getId()) {
			...
			// «Wrong order ID: "". at vendor/magento/module-paypal/Model/Ipn.php:140»:
			// https://github.com/inkifi/site/issues/9
        	df_log_l($this, ['request' => df_request(), 'url' => df_current_url()], 'ipn');
